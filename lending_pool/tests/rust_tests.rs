...
fn deposit_test() {
    ...
    lending_setup
        .b_mock
        .set_dcdt_balance(&user_addr, USDC_TOKEN_ID, &rust_biguint!(1_000));
...
fn liquidate_test() {
    ...
    lending_setup
        .b_mock
        .set_dcdt_balance(&liquidatee_user, USDC_TOKEN_ID, &rust_biguint!(1_000));
    ...
    lending_setup
        .b_mock
        .set_dcdt_balance(&liquidator_user, USDC_TOKEN_ID, &rust_biguint!(300));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&user_addr, USDC_TOKEN_ID, &rust_biguint!(2_000 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(200_000));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&borrower_addr, EGLD_TOKEN_ID, &rust_biguint!(1_000));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&liquidator_addr, USDC_TOKEN_ID, &rust_biguint!(100_000));
...
//     // Supply/Deposit
//     lending_setup.b_mock.set_dcdt_balance(
//         &supplier_addr,
//         USDC_TOKEN_ID,
//         &rust_biguint!(2_000 * BP),
//     );
...
//     lending_setup
//         .b_mock
//         .check_dcdt_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(630 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(412 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&alice_addr, USDC_TOKEN_ID, &rust_biguint!(40_000 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&bob_addr, USDC_TOKEN_ID, &rust_biguint!(20_000 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dcdt_balance(&eve_addr, USDC_TOKEN_ID, &rust_biguint!(12_660 * BP));
...
//     lending_setup
//         .b_mock
//         .check_dcdt_balance(&eve_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .check_dcdt_balance(&dave_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .check_dcdt_balance(&charlie_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .check_dcdt_balance(&borrower2_addr, USDC_TOKEN_ID, &rust_biguint!(0));
